...
const VTABLE = bam_stage.BamStage.VTable{
    .process = MapqdistributionStage.process,
    .finalize = MapqdistributionStage.finalize,
    .report = MapqdistributionStage.report,
    .reportJson = MapqdistributionStage.reportJson,
};
