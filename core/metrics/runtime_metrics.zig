...
pub const RuntimeMetrics = struct {
    ...
    pub fn report(self: *const RuntimeMetrics, writer: std.io.AnyWriter) void {
        ...
        writer.print("Runtime Observability:\n", .{}) catch {};
        writer.print("  Total Time: {d:.2}s\n", .{elapsed_s}) catch {};
        writer.print("  Throughput: {d:.2} reads/sec\n", .{throughput}) catch {};
    }
};
